...
urlpatterns = [
    ...
    path('DWH/', API_Datawarehouse_D_TYPE_VACCIN.as_view()),
    path('DWH/', API_Datawarehouse_D_DATE.as_view()),
    path('DWH/', API_Datawarehouse_D_LOCATION.as_view()),
    path('DWH/', API_Datawarehouse_F_FLUX.as_view()),
]   